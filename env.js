 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.swiftycompanion.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.swiftycompanion'; // ios bundle id
const PACKAGE = 'com.swiftycompanion'; // android package name
